...
class MenuAddRestaurantViewAddMultiselectAdapter (
...
):RecyclerView.Adapter<MenuAddRestaurantViewAddMultiselectAdapter.MultiselectViewHolder>() {
    ...
    */
     ...
     */
    fun addSelectedItem(){
        database = FirebaseDatabase.getInstance().getReference("Menus/" + id + "/Restaurants/")
