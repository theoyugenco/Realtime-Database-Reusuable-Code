...
class MenuItemAdd : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (data != null) {
            if (data.data != null) {
                ...
                binding.dishImage.setImageURI(selectedImg)
    ...
    private fun uploadData(){
        ...
        if ((!(name.isNullOrEmpty()))  && (!(price.isNullOrEmpty())) && (!(description.isNullOrEmpty())) ){
            ...
            if ((!(key.isNullOrEmpty())) && (!(uid.isNullOrEmpty()))){
                ...
                val newMenuItem: MenuItemDC = MenuItemDC(name, price, description, key, uid)
                //This is the portion that will upload the fields to RTD
                database.child(key!!).setValue(newMenuItem).addOnSuccessListener {
                    ...
                    storage.putFile(selectedImg).addOnSuccessListener {
                        ...
                        val newPushedMenuItem: DatabaseReference = database.push()
                        key = newPushedMenuItem.key.toString()
