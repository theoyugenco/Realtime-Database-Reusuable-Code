...
class FavoriteRestaurants : AppCompatActivity() {
    private var TAG: String? = null
    private lateinit var database: DatabaseReference
    private lateinit var auth: FirebaseAuth
    private var restaurantMenu: Menu? = null
    private lateinit var rv: RecyclerView
    private lateinit var msAdapter: FavoriteRestaurantsMultiselectAdapter
    ...
    private fun getUserData(){
        ...
        database.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                Toast.makeText(this@FavoriteRestaurants, "onDataChanged!", Toast.LENGTH_SHORT).show()
                if (snapshot.exists()) {
                    //restaurantArrayList.clear()
                    ...
                    msAdapter =
                        FavoriteRestaurantsMultiselectAdapter(restaurantArrayList) { show ->
                            showDeleteMenu(show)
                        }
...
database.addValueEventListener(object : ValueEventListener {
    ...
    private fun addFavorites(){
        ...
        alertDialog.setTitle("Favorite Location(s)")
        alertDialog.setMessage("Do you want to favorite these locations?")
        alertDialog.setPositiveButton("Favorite"){_,_ ->
